/*global history */
sap.ui.define([
	"com/sap/demo/customer/order/maintenance/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"sap/m/GroupHeaderListItem",
	"sap/ui/Device",
	"com/sap/demo/customer/order/maintenance/model/formatter",
	"sap/m/MessageBox",
	"com/sap/demo/customer/order/maintenance/model/grouper",
	"com/sap/demo/customer/order/maintenance/model/GroupSortState"
], function(BaseController, JSONModel, Filter, FilterOperator, GroupHeaderListItem, Device, formatter, MessageBox, grouper,
	GroupSortState) {
	"use strict";

	return BaseController.extend("com.sap.demo.customer.order.maintenance.controller.Master", {
		...
		onOpenViewSettings: function() {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("com.sap.demo.customer.order.maintenance.view.ViewSettingsDialog", this);
