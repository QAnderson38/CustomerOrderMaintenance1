sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/sap/demo/customer/order/maintenance/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#CustomerOrderMaintenance1-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#CustomerOrderMaintenance1-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("com.sap.demo.customer.order.maintenance.test.integration.pages.Common", {
		...
		getMockServer: function() {
			return new Promise(function(success) {
				Opa5.getWindow().sap.ui.require(["com/sap/demo/customer/order/maintenance/localService/mockserver"], function(mockserver) {
