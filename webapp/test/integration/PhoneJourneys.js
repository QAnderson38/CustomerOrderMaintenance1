...
sap.ui.require([
	...
	sap.ui.require([
		"com/sap/demo/customer/order/maintenance/test/integration/NavigationJourneyPhone",
		"com/sap/demo/customer/order/maintenance/test/integration/NotFoundJourneyPhone",
		"com/sap/demo/customer/order/maintenance/test/integration/BusyJourneyPhone"
	], function() {
		QUnit.start();
	});
});